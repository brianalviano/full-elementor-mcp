		...
		switch ( $type ) {
			...
			case 'switcher':
				return array(
					'type'        => 'string',
					'enum'        => array( 'yes' ),
					'description' => __( 'Toggle switch. Use "yes" to enable, omit or send empty string to disable.', 'full-elementor-mcp' ),
				);
			...
			case 'popover_toggle':
				return array(
					'type'        => 'string',
					'enum'        => array( 'yes' ),
					'description' => __( 'Popover toggle. Use "yes" to enable, omit or send empty string to disable.', 'full-elementor-mcp' ),
				);
